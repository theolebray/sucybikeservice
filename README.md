[index(7).html](https://github.com/user-attachments/files/26985533/index.7.html)[Uploading index<!DOCTYPE html>
<html lang="fr">
<head>
  <meta charset="UTF-8">
...
<script>
  ...
  function sendGmail() {
    // Sur tous les appareils : ouvre Gmail/mail avec juste le "À" pré-rempli
