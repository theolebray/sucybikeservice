[tarifs-velo(1).html](https://github.com/user-attachments/files/26982354/tarifs-velo.1.html)
<!DOCTYPE html>
<html lang="fr">
<head>
  <meta charset="UTF-8">
  ...
  <script>
    // Génère un lien Gmail compose
    function gmail(sujet, corps) {
      const to = "theolebray@gmail.com";
    ...
    function goGmail(sujet, corps) {
      window.open(gmail(sujet, corps), '_blank');
    }

    const corps = (prestation, prix, extra) =>
...
<div class="grid">
  ...
  <!-- 1 Nettoyage Express -->
  <div class="card c-orange" onclick="goGmail('Demande – Nettoyage Express (15€)', corps('Nettoyage Express', '15€', ''))">
  ...
  <!-- 2 Remise en route -->
  <div class="card c-navy" onclick="goGmail('Demande – Remise en route (30€)', corps('Remise en route', '30€', ''))">
  ...
  <!-- 3 Entretien complet -->
  <div class="card c-green" onclick="goGmail('Demande – Entretien complet (50€)', corps('Entretien complet', '50€', ''))">
  ...
  <!-- 4 Entretien avancé -->
  <div class="card c-rust" onclick="goGmail('Demande – Entretien avancé (70€)', corps('Entretien avancé', '70€', ''))">
  ...
  <!-- 5 Lavage Pro -->
  <div class="card c-slate" onclick="goGmail('Demande – Lavage Pro (60€)', corps('Lavage Pro', '60€', 'Option graissage chaîne +5€ : OUI / NON'))">
  ...
  <div class="card c-gray" style="cursor:default;">
    ...
    <div class="card-body">
      ...
      <div class="carte-item" onclick="event.stopPropagation(); goGmail('Demande – Réglage freins (15€)', corps('Réglage freins', '15€', ''))">
        <span class="label">Réglage freins</span><span class="prix">15€</span>
      </div>
      <div class="carte-item" onclick="event.stopPropagation(); goGmail('Demande – Chambre à air (20€/pièce)', corps('Chambre à air', '20€ / pièce', 'Nombre de pièces : '))">
        <span class="label">Chambre à air</span><span class="prix">20€ / pièce</span>
      </div>
      <div class="carte-item" onclick="event.stopPropagation(); goGmail('Demande – Chaîne (30€/pièce)', corps('Chaîne', '30€ / pièce', 'Nombre de pièces : '))">
        <span class="label">Chaîne</span><span class="prix">30€ / pièce</span>
      </div>
      <div class="carte-item" onclick="event.stopPropagation(); goGmail('Demande – Pneus complets (35€/pièce)', corps('Pneus complets', '35€ / pièce', 'Nombre de pièces : '))">
        <span class="label">Pneus complets</span><span class="prix">35€ / pièce</span>
      </div>
      <div class="carte-item" onclick="event.stopPropagation(); goGmail('Demande – Réglage dérailleur (20€)', corps('Réglage dérailleur', '20€', ''))">
